    ...
    <div className="min-h-screen bg-black text-white">
      <section className="relative overflow-hidden px-4 py-20 sm:px-6 lg:px-8">
        ...
        <div className="relative z-10 mx-auto grid max-w-7xl gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div>
            <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-[#826c63]/40 bg-black/50 px-4 py-2 text-sm text-[#e2d5d1] backdrop-blur-sm">
              <FaSearchDollar className="text-[#5eead4]" />
            ...
            <div className="mt-8 flex flex-col gap-4 sm:flex-row">
              <Link
                href="/projects"
                className="inline-flex items-center justify-center rounded-full border border-[#826c63] bg-[#826c63]/20 px-6 py-3 font-semibold text-white transition hover:bg-[#826c63]/35"
              >
      ...
      <section className="border-y border-white/10 bg-[#080808] px-4 py-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
